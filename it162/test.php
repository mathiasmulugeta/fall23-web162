...
<body>
	...
	<?php
        ...
        $toAddress = "mathiasmulugeta@gmail.com";  //place your/your client's email address here
        $toName = "Mathias Mulugeta"; //place your client's name here
        $website = "CLIENT WEBSITE 162";  //place NAME of your client's website
